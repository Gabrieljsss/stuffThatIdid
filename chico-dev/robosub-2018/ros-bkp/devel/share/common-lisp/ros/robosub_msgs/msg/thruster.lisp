...
(cl:defmethod cl:initialize-instance :after ((m <thruster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'thruster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robosub_msgs-msg:<thruster> is deprecated: use robosub_msgs-msg:thruster instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <thruster>))
