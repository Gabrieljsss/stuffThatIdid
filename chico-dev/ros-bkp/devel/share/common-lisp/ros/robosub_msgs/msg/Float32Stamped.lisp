...
(cl:defmethod cl:initialize-instance :after ((m <Float32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robosub_msgs-msg:<Float32Stamped> is deprecated: use robosub_msgs-msg:Float32Stamped instead.")))
