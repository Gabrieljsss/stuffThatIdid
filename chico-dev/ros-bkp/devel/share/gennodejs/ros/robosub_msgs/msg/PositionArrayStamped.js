...
class PositionArrayStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PositionArrayStamped(null);
  ...
  static getMessageSize(object) {
    ...
    length += 28 * object.positions.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositionArrayStamped(null);
...
module.exports = PositionArrayStamped;
